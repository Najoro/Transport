$(document).ready(function () {
  ...
  var data = [
    ...
    },
    {
      ...
      name: "Zo",
      hotel: "Colbert",
      adresse: "1 avenue de l'Indépendance, Antananarivo",
      contact: "0342345678",
      point: "126",
    },
    {
      ...
      name: "Mamy",
      hotel: "Palissandre",
      adresse: "45 rue Ravelojaona, Tana",
      contact: "0343456789",
      point: "156",
    },
    {
    ...
    },
    {
      ...
      name: "Rina",
      hotel: "Sole",
      adresse: "3 rue de Faravohitra, Antananarivo",
      contact: "0345678901",
      point: "66",
    },
    {
      ...
      name: "Fy",
      hotel: "A&C Hotel",
      adresse: "23 boulevard de l'Europe, Ivato",
      contact: "0346789012",
      point: "76",
    },
    {
      ...
      name: "Tsiry",
      hotel: "Sunny Garden",
      adresse: "56 avenue de l'Aviation, Ivandry",
      contact: "0347890123",
      point: "86",
    },
    {
      ...
      name: "Zo",
      hotel: "Calypso",
      adresse: "1 rue de l’Océan Indien, Toamasina",
      contact: "0348901234",
      point: "96",
    },
    {
      ...
      adresse: "14 rue Ravelojaona, Isoraka",
      contact: "0349012345",
      point: "26",
    },
    {
      ...
      name: "Hery",
      hotel: "Le Raphia",
      adresse: "2 rue Ratsimilaho, Fianarantsoa",
      contact: "0340123456",
      point: "66",
    },
    {
    ...
    cars.forEach((car, index) => {
      ...
      data.forEach((element) => {
        if (element.place == "c") {
          TemplanteDriver =
            element.personale == ""
              ? Templante.defaultDriver(element)
              : Templante.driver(element);
        } else {
          defaulteTemplante +=
            element.personale == ""
